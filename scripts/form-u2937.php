...
{
	$to = '';
	$subject = 'JKI Group | Design & Build | Contact Us Form Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name: (required):</b></td><td>' . htmlentities($_REQUEST["custom_U2955"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Email: (required):</b></td><td>' . htmlentities($_REQUEST["Email"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Message: (required):</b></td><td>' . htmlentities($_REQUEST["custom_U2960"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Phone: (optional):</b></td><td>' . htmlentities($_REQUEST["custom_U2950"],ENT_COMPAT,'UTF-8') . '</td></tr>';

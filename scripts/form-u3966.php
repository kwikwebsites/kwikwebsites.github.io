...
function emailFormSubmission()
{
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name: (required):</b></td><td>' . htmlentities($_REQUEST["custom_U3986"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Message: (required):</b></td><td>' . htmlentities($_REQUEST["custom_U3967"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Phone: (optional):</b></td><td>' . htmlentities($_REQUEST["custom_U3981"],ENT_COMPAT,'UTF-8') . '</td></tr>';
